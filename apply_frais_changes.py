...
FRAIS = r"c:\Users\cedri\OneDrive - ELITE CAPITAL Group S.A\Documents\EMS\extranet\frontend\src\pages\FraisPage.jsx"
MISSIONS = r"c:\Users\cedri\OneDrive - ELITE CAPITAL Group S.A\Documents\EMS\extranet\frontend\src\pages\MissionsPage.jsx"
...
# ── FRAIS 1: add preuves_paiement to fraisPaymentStatuts map ──
old1 = (
...
if old1 in frais:
    ...
    errors.append("FRAIS 1: NOT FOUND")
...
# ── FRAIS 3: fix colSpan ──
old3 = "colSpan={isRecu ? 11 : 10}"
new3 = "colSpan={isRecu ? 12 : 11}"
if old3 in frais:
    frais = frais.replace(old3, new3, 1)
    print("FRAIS 3: OK")
else:
    errors.append("FRAIS 3: NOT FOUND")
...
old5 = '            <div className="form-group"><label>ID Frais</label><input value={preuveUpload.id_frais} onChange={(e) => setPreuveUpload({ ...preuveUpload, id_frais: e.target.value })} required placeholder="Entrez l\'ID de la demande de frais" /></div>'
new5 = (
