...
export default function PermissionsPage() {
  ...
  const renderActionButtons = (item, isRecu) => {
    ...
    const eyeBtn = <button key="eye" onClick={(e) => { e.stopPropagation(); setDetailPermissionItem({ ...item, ...(permissionsById.get(item.id_operation) || {}) }) }} className="btn-ghost-primary" style={{ ...rowBtn, display: 'inline-flex', alignItems: 'center' }} title="Voir détails"><Eye size={12} /></button>
