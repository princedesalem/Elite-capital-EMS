...
export default function Utilisateurs() {
  ...
  return (
    <div style={{ padding: '12px', background: '#f4f5f7', minHeight: '100vh' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
          <div>
            ...
            <div style={{ fontSize: '0.83rem', opacity: 0.95 }}>
              Administration des comptes, sécurité MFA et création de nouveaux accès.
            </div>
          </div>
          <button
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10, marginBottom: 14 }}>
        <div className="card" style={{ padding: '12px 14px', borderLeft: '5px solid #374151' }}>
          ...
          <div style={{ marginTop: 2, fontSize: '1.35rem', fontWeight: 800, color: '#0f172a' }}>{utilisateursStats.total}</div>
        </div>
        <div className="card" style={{ padding: '12px 14px', borderLeft: '5px solid #4b5563' }}>
          <div style={{ fontSize: '0.77rem', color: '#64748b', fontWeight: 700, display: 'flex', gap: 6, alignItems: 'center' }}><ShieldCheck size={13}/> Actifs</div>
        ...
        <div className="card" style={{ padding: '12px 14px', borderLeft: '5px solid #6b7280' }}>
          <div style={{ fontSize: '0.77rem', color: '#64748b', fontWeight: 700 }}>MFA actifs</div>
        ...
        <div className="card" style={{ padding: '12px 14px', borderLeft: '5px solid #9ca3af' }}>
          <div style={{ fontSize: '0.77rem', color: '#64748b', fontWeight: 700, display: 'flex', gap: 6, alignItems: 'center' }}><KeyRound size={13}/> MDP temporaires</div>
      ...
      {creerCompteModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.45)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ background: '#fff', borderRadius: 12, padding: 28, minWidth: 360, maxWidth: 440, boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
            ...
            <div style={{ marginBottom: 18 }}>
              <label style={{ fontSize: '0.82rem', fontWeight: 600, color: '#374151' }}>
                Mot de passe initial <span style={{ fontWeight: 400, color: '#6b7280' }}>(laisser vide = auto-généré)</span>
              </label>
              ...
              <p style={{ margin: '4px 0 0', fontSize: '0.76rem', color: '#6b7280' }}>Min. 14 caractères, 1 majuscule, 1 minuscule, 1 chiffre, 1 caractère spécial.</p>
            </div>
            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
              <button onClick={() => setCreerCompteModal(null)} style={{ padding: '8px 18px', borderRadius: 7, border: '1px solid #d1d5db', background: '#f1f5f9', cursor: 'pointer', fontWeight: 600 }}>Annuler</button>
              <button onClick={soumettreCreerCompte} disabled={creerCompteLoading}
                ...
                {creerCompteLoading ? 'Création...' : 'Créer le compte'}
              </button>
            </div>
          </div>
        </div>
      ...
      {showNouveauComptePanel && (
        <div className="card" style={{ marginBottom: 14, padding: 0, overflowX: 'auto', border: '1px solid #d1d5db' }}>
          <div style={{ padding: '11px 13px', background: 'linear-gradient(90deg, #f3f4f6 0%, #f8fafc 100%)', borderBottom: '1px solid #d1d5db', fontWeight: 700, fontSize: '0.85rem', color: '#111827', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
      ...
      <div className="card" style={{ marginBottom: 12, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 8, border: '1px solid #e2e8f0' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.83rem' }}>
          <thead>
            <tr style={{ background: 'linear-gradient(180deg, #f8fafc 0%, #eef2f7 100%)', color: '#021630' }}>
              ...
              <th style={{ textAlign: 'left', padding: '9px 10px', color: '#021630', fontWeight: 800 }}>Role</th>
              <th style={{ textAlign: 'left', padding: '9px 10px', color: '#021630', fontWeight: 800 }}>Etat</th>
